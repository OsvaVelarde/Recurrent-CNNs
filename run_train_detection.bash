...
DATABASE_PATH='/media/osvaldo/Seagate Basic/COCO/'
OUTPUT_PATH='results/detection/training-evolution/'$TITLE'_terminal.txt'

export PYTHONPATH=$(pwd):$PYTHONPATH

echo 'Training Stage - Model' $TITLE

python3.7 src/training_detection.py \
    --PATH $_PATH \
    --title  $TITLE\
    ...
    --rzs-chs $RZS_CHS \
    --type-agg $TYPE_AGG \
    --func-agg $FUNC_AGG | tee $OUTPUT_PATH